...
def calculate_indicators(df, symbol):
    ...
    #df.loc[(df['pivot_up']) & (df['dc_position_ratio_50'] > 60) & (df['close'] < 'nw_upper'), 'atr_steps'] = 'long'
    #df.loc[(df['pivot_down']) & (df['dc_position_ratio_50'] < 40) & (df['close'] > 'nw_lower'), 'atr_steps'] = 'short' 
